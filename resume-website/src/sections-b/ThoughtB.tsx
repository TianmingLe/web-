...
export default function ThoughtB() {
  return (
    <section className="px-6 md:px-12 lg:px-20 pt-24 pb-16 md:pt-32 md:pb-20 max-w-6xl mx-auto">
      ...
      <Reveal delay={0.1}>
        <p className="font-b-sans text-b-ink-light text-base leading-relaxed max-w-3xl mb-12">
          {thoughtData.description}
        </p>
      </Reveal>

      <Reveal delay={0.15}>
        <div className="relative pl-8 pr-6 py-6 mb-16 b-card" style={{ borderLeft: '3px solid var(--color-b-terracotta)' }}>
