...
/* ------------------------------------------------------------------ */
const CONTAINER_SM = 400   // mobile base (px)
const CONTAINER_MD = 800   // desktop base (px)
const CONTAINER_LG = 960   // desktop large (px)
...
function MainNodeItem({
  ...
  const radius = isLoaded ? (isMobile ? 160 : 300) : 0
  ...
  const webSize = isMobile ? 240 : 360
